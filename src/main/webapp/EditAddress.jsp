...
<%
	...
	Address c = new AddressHandler().fetchAddressByid(id);
	...
	<form style="padding-top: 10%;" action="AddToAddress" method="post">
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				<label for="inputEmail4">Name</label> <input type="text" value="${currCat.getName()}
					class="form-control" id="inputEmail4" placeholder="Name"
					name="name">
			</div>
			<div class="form-group col-md-6">
				<label for="inputPassword4">Phone</label> <input type="number" value="${currCat.getPhone()}
